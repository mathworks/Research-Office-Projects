...
Compute the score: **&tau; / (2&tau; - 1)**. Repeat many times and multiply the average by 4. The estimate converges to &pi;.
...
The stopping rule P(red) = 1/(2k) produces a PMF involving central binomial coefficients. Those coefficients connect to the arcsin series, one of the classical representations of &pi;. The Symbolic Math Toolbox&trade; proves the expected score in one line:
